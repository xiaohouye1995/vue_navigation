...
export const constantRoutes: RouterTy = [
  ...
  {
    path: '/',
    component: () => import('@/views/front-nav/index.vue'),
    hidden: true
  },
  {
      path: '/dashboard',
      ...
      children: [
        {
          ...
          name: 'Dashboard',
          meta: { title: 'Dashboard', icon: 'Fold' }
        }
      ]
    },
  {
    path: '/navigation',
    component: Layout,
    redirect: '/navigation/menus',
    name: 'Navigation',
    meta: { title: '网址导航', icon: 'example' },
    children: [
      {
        path: '/navigation/menus',
        name: 'menus',
        component: () => import('@/views/navigation/menus/index.vue'),
        meta: { title: '菜单列表' }
      }
    ]
  },
